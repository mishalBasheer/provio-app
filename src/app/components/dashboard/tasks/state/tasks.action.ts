...
export const GET_ALL_ORGS='[workspace page] get all orgs';
...
export const getAllOrgs=createAction(GET_ALL_PROJECTS);
export const getAllProjects=createAction(GET_ALL_PROJECTS);
export const getAllBoards=createAction(GET_ALL_PROJECTS);
export const getBoardById=createAction(GET_ALL_PROJECTS,props<{id:string}>);